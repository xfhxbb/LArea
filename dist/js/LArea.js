...
window.LArea = (function() {
    ...
    MobileArea.prototype = {
        ...
        finish: function(e) {
            ...
            function combineParams(paramsArr) {
            ...
            _self.trigger.value = combineParams([provinceText,cityText,countyText]);
            _self.value = combineParams([provinceVal, cityVal, countyVal]).split(',');
            if(this.valueTo){
